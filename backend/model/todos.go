...
type Todo struct {
	...
	Completed uint8     `boil:"completed" json:"completed" toml:"completed" yaml:"completed"`
...
var (
	todoAllColumns            = []string{"id", "title", "completed", "created_at", "updated_at"}
	todoColumnsWithoutDefault = []string{"id", "title", "created_at", "updated_at"}
